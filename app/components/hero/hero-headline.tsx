export function HeroHeadline() {
  return (
    <div className="pointer-events-none relative z-10 flex h-full flex-col items-center justify-center px-4">
      ...
      <h2 className="mt-3 max-w-4xl text-center text-[clamp(24px,3vw,35px)] font-medium leading-[1.1] tracking-[-0.03em] text-[var(--gray-9)]">&mdash; and scale to 800K+ users.</h2>
